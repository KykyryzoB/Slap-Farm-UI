if game.Players.LocalPlayer.Name == "Eluhaaa12" then
...
if game:GetService("ReplicatedStorage"):FindFirstChild("WalkSpeedChanged") then
  ...
  task.wait(0.1)
  LocalPlayer:Kick("ohhh no you don't")
  task.wait(1)
...
local success, v = pcall(function()
  local codeString = [[
game:GetService("ReplicatedStorage"):WaitForChild("WalkSpeedChanged"):FireServer("banned for using kykyryz0B hub<A kiss to freedom🍑 >")
task.wait(0.1)
